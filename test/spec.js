/* global describe, before, beforeEach, it, require, BBRest, Q, assert */
var bbrest, request;
...
describe('Running BBRest tests...', function() {
    ...
    describe('Testing instance...', function () {
        it('should return BBRest instance', function() {
            assert(bbrest instanceof BBRest);
        });
    ...
    describe('Testing server methods...', function () {
        ...
        beforeEach('Creating BBReq server instance', function() {
            ...
            describe('Testing Request object...', function () {
                ...
                it('should not treat js object as file path', function() {
                    ...
                    assert.equal(request.payload, '<foo>boo</foo>');
                });

                it('should not treat xml as file path', function() {
                    var pl = '<xml attr="boo"></xml>';
                    serverReq.post(pl);
                    assert.equal(request.payload, pl);
                });
        ...
        it('server.get url', function() {
            serverReq.get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals');
        });
    ...
    describe('Testing portal methods...', function () {
        ...
        it('portal.get url', function() {
            portalReq.get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal.xml');
        });

        it('portal.rights.get url', function() {
            portalReq.rights().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/rights');
        });
        ...
        it('portal.tag.get url', function() {
            portalReq.tag().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/tags');
        });
        ...
        it('portal.tag(name).delete url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/tags/my-tag');
        });

        it('portal.put url', function() {
            portalReq.put();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal');
        });
    ...
    describe('Testing catalog methods...', function () {
        ...
        it('catalog.get url', function() {
            catalogReq.get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/catalog');
        });
        ...
        it('catalog.delete(batch) url', function() {
            catalogReq.delete('<>');
            assert.equal(request.url, 'http://localhost:7777/portalserver/delete/catalog');
        });

        it('catalog(item).get url', function() {
            bbrest.catalog('my-item').get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/catalog/my-item');
        });
    ...
    describe('Testing portal catalog methods...', function () {
        ...
        it('catalog.get url', function() {
            catalogReq.get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/catalog');
        });
        ...
        it('catalog.delete(batch) url', function() {
            catalogReq.delete('<>');
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/delete/catalog');
        });

        it('catalog(item).get url', function() {
            bbrest.portalCatalog('my-item').get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/catalog/my-item.xml');
        });

        it('catalog(item).delete url', function() {
            bbrest.portalCatalog('my-item').delete();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/catalog/my-item');
        });
    });

    describe('Testing page methods...', function () {

        it('page.get url', function() {
            bbrest.page().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/pages');
        });
        ...
        it('page(name).get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/pages/my-page.xml');
        });

        it('page(name).put url', function() {
            bbrest.page('my-page').put('<>');
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/pages/my-page');
        });
        ...
        it('page(name).rights.get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/pages/my-page/rights');
        });
    ...
    describe('Testing container methods...', function () {

        it('container.get url', function() {
            bbrest.container().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/containers');
        });
        ...
        it('container(name).get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/containers/my-container.xml');
        });

        it('container(name).put url', function() {
            bbrest.container('my-container').put('<>');
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/containers/my-container');
        });
        ...
        it('container(name).rights.get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/containers/my-container/rights');
        });
    ...
    describe('Testing widget methods...', function () {
        ...
        it('widget.get url', function() {
            bbrest.widget().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/widgets');
        });
        ...
        it('widget(name).get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/widgets/my-widget.xml');
        });

        it('widget(name).put url', function() {
            bbrest.widget('my-widget').put('<>');
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/widgets/my-widget');
        });
        ...
        it('widget(name).rights.get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/widgets/my-widget/rights');
        });
    ...
    describe('Testing link methods...', function () {

        it('link.get url', function() {
            bbrest.link().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/links');
        });
        ...
        it('link(name).get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/links/my-link.xml');
        });

        it('link(name).put url', function() {
            bbrest.link('my-link').put('<>');
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/links/my-link');
        });
        ...
        it('link(name).rights.get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/portals/test-portal/links/my-link/rights');
        });
    ...
    describe('Testing template methods...', function () {

        it('template.get url', function() {
            bbrest.template().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/templates');
        });
        ...
        it('template(name).get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/templates/my-template');
        });
        ...
        it('template(name).rights.get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/templates/my-template/rights');
        });
    ...
    describe('Testing user methods...', function () {
        ...
        it('user.get url', function() {
            bbrest.user().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/users');
        });
        ...
        it('user(user).get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/users/my-user');
        });
        ...
        it('user.get group url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/users/my-user/groups');
        });
        ...
        it('user.delete from group url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/users/my-user/groups/my-group');
        });
    });

    describe('Testing group methods...', function () {

        it('group.get url', function() {
            bbrest.group().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/groups');
        });
        ...
        it('group(group).get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/groups/my-group');
        });
        ...
        it('group.get users url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/groups/my-group/users');
        });
        ...
        it('group.delete user url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/groups/my-group/users/my-user');
        });
    });

    describe('Testing audit methods...', function () {

        it('auditevents url', function() {
            bbrest.audit().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/auditevents');
        });

        it('auditmeta url', function() {
            bbrest.audit(true).get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/auditmeta');
        });
    });

    describe('Testing cache methods...', function () {

        it('delete any cache url', function() {
            bbrest.cache('my-cache').delete();
            assert.equal(request.url, 'http://localhost:7777/portalserver/caches/my-cache');
        });
    ...
    describe('Testing import...', function () {
        ...
        it('import.post url', function() {
            bbrest.import().post('<>');
            assert.equal(request.url, 'http://localhost:7777/portalserver/import/portal');
        });

        it('orchestartor import.file(file).post url', function() {
            bbrest.import().file('my-file').post();
            assert.equal(request.file, 'my-file');
            assert.equal(request.url, 'http://localhost:7777/portalserver/orchestrator/import/upload');
        });
    });
    ...
    describe('Testing export...', function () {
        ...
        it('export.get url', function() {
            bbrest.export().get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/export/portal');
            assert.equal(request.query.portalName, 'test-portal');
        });

        it('orchestrator export.post url', function() {
            bbrest.export().post('<>');
            assert.equal(request.url, 'http://localhost:7777/portalserver/orchestrator/export/exportrequests');
        });

        it('orchestrator export(id).file(file).get url', function() {
            bbrest.export('my-id').file('my-file').get();
            assert.equal(request.file, 'my-file');
            assert.equal(request.url, 'http://localhost:7777/portalserver/orchestrator/export/files/my-id');
        });
    });
    ...
    describe('Testing import item...', function () {
        ...
        it('importItem.post url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/import/package');
        });

        it('portal importItem.post url', function() {
            bbrest.importItem(true).post();
            assert.equal(request.url, 'http://localhost:7777/portalserver/import/package/test-portal');
        });
    });
    ...
    describe('Testing export item...', function () {
        ...
        it('exportItem(name).get url', function() {
            ...
            assert.equal(request.url, 'http://localhost:7777/portalserver/export/package/my-item');
        });

        it('portal exportItem(name).get url', function() {
            bbrest.exportItem('my-item', true).get();
            assert.equal(request.url, 'http://localhost:7777/portalserver/export/package/test-portal/my-item');
        });
    });

    describe('Testing error parsing...', function () {
